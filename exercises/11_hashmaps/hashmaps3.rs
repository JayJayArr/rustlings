...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // team_1.
        let Team1scores = scores.entry(String::from(team_1_name)).or_insert(Team {goals_scored: 0, goals_conceded: 0});
        Team1scores.goals_scored += team_1_score;
        Team1scores.goals_conceded += team_2_score;
        let Team2scores = scores.entry(String::from(team_2_name)).or_insert(Team {goals_scored: 0, goals_conceded: 0});
